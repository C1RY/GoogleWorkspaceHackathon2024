...
function getPageContent(topic) {
  ...
  switch (topic) {
    ...
    case 'leave_manage':
      return HtmlService.createHtmlOutputFromFile('leave_manage').getContent();
    case 'EmpAddLeave':
      return HtmlService.createHtmlOutputFromFile('EmpAddLeave').getContent();
    case 'hr_leave_manage':
      return HtmlService.createHtmlOutputFromFile('hr_leave_manage').getContent();
    case 'HRAddLeave':
    ...
    case 'detailed_metrics':
      return HtmlService.createHtmlOutputFromFile('detailed_metrics').getContent();
    case 'feedback':
